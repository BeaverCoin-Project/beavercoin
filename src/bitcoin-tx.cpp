...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BeaverCoin Core beavercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beavercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beavercoin transaction") + "\n" +
              "  beavercoin-tx [options] -create [commands]   " + _("Create hex-encoded beavercoin transaction") + "\n" +
              "\n";
