...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        (     0, uint256("0x4daea126edbcc5657db163e07e7ca44ffa095135599e2a9d1c73a125c539515f"))
        (303490, uint256("0x34d0ef2265eeaa5cee4264f9de3f00e5602ab1d0ebb3dd7775070ca693d42bdf"))
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1421386931, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams() {
        ...
        // BeaverCoin: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        // BeaverCoin: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // BeaverCoin: v2 enforced using Bitcoin's supermajority rule
