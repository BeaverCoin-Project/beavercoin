...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BeaverCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"beavercointools.com", "dnsseed.beavercointools.com"},
    {"beavercoinpool.org", "dnsseed.beavercoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"beavercointools.com", "testnet-seed.beavercointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BeaverCoin is probably already running."), addrBind.ToString().c_str());
        else
